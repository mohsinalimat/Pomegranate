...
Pod::Spec.new do |s|
  s.name             = 'Pomegranate'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Pomegranate.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tonyyasi/Pomegranate'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tonyyasi' => 'tonyyasi@gmail.com' }
  s.source           = { :git => 'https://github.com/tonyyasi/Pomegranate.git', :tag => s.version.to_s }
